...
class Restaurant:
    ...
    def __init__(self, restaurant_info_df, allow_restart=False, tts=False, caps=False, filename=None):
        ...
        self.system_info_retriever = SystemInfoRetriever(self.info_dict, restaurant_info_df=self.restaurant_info_df)
    ...
    def run_system(self):
        ...
        while True:
            ...
            # move to next state
            self.system_message_generator.generate_next_step(predicted_intent=predicted_intent,
